...
public class BuildingManager : MonoBehaviour
{
    ...
    public void OnPrefabSelect(int prefabNum) {
        SelectionManager.Instance.OnPrefabCreation();
        Object.Destroy(prefabObject);

        prefabObject = (GameObject)Instantiate(buildingPrefabs[prefabNum]);
        prefabType = (BuildingEnum)prefabNum;
    ...
    void Start()
    {
        prefabObject = (GameObject)Instantiate(buildingPrefabs[0]);
